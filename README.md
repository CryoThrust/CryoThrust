...
| [MCP Servers](https://github.com/modelcontextprotocol/servers) | 修复 filesystem 的 UTF-8 分块边界乱码、POSIX 环境 Windows 路径误解析，以及递归创建目录时的路径校验阻断。<br>[PR #4703](https://github.com/modelcontextprotocol/servers/pull/4703) · [PR #4704](https://github.com/modelcontextprotocol/servers/pull/4704) · [PR #4705](https://github.com/modelcontextprotocol/servers/pull/4705) | CI 通过，Review 中 |
