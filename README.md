...
| [OpenViking](https://github.com/volcengine/OpenViking) | 修复 `context_type=skill` 的隐式检索目标解析、记忆合并中的重复行号前缀累积、OpenAI-compatible embedding 的显式多模态配置透传，以及目录摘要提取将 Markdown 分隔线误写入语义 sidecar 的问题。<br>[PR #4423](https://github.com/volcengine/OpenViking/pull/4423) · [PR #4424](https://github.com/volcengine/OpenViking/pull/4424) · [PR #4432](https://github.com/volcengine/OpenViking/pull/4432) · [PR #4434](https://github.com/volcengine/OpenViking/pull/4434) | Review 中 |
| [MCP Servers](https://github.com/modelcontextprotocol/servers) | 修复 filesystem 的 UTF-8 分块边界乱码、POSIX 环境 Windows 路径误解析、递归创建目录时的路径校验阻断，以及移动文件覆盖现有目标的问题。<br>[PR #4703](https://github.com/modelcontextprotocol/servers/pull/4703) · [PR #4704](https://github.com/modelcontextprotocol/servers/pull/4704) · [PR #4705](https://github.com/modelcontextprotocol/servers/pull/4705) · [PR #4706](https://github.com/modelcontextprotocol/servers/pull/4706) | CI 通过，Review 中 |
