...
| [OpenViking](https://github.com/volcengine/OpenViking) | 修复 `context_type=skill` 的隐式检索目标解析、记忆合并中的重复行号前缀累积、OpenAI-compatible embedding 的显式多模态配置透传，以及知识图谱推荐 `module` 类型的可视化降级。<br>[PR #4423](https://github.com/volcengine/OpenViking/pull/4423) · [PR #4424](https://github.com/volcengine/OpenViking/pull/4424) · [PR #4432](https://github.com/volcengine/OpenViking/pull/4432) · [PR #4435](https://github.com/volcengine/OpenViking/pull/4435) | Review 中 |
